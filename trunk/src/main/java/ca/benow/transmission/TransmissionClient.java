...
public class TransmissionClient {
	...
	public JSONObject sendCommand(String name, JSONObject args)
			throws IOException, TransmissionException, JSONException {
	...
	public List<TorrentStatus> getTorrents(int[] ids,
			TorrentStatus.TorrentField[] requestedFields) throws IOException, JSONException {
	...
	public AddedTorrentInfo addTorrent(String downloadDir, InputStream metaInfo,
			...
			int[] priorityNormal) throws IOException, JSONException {
